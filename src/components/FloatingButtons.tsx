    ...
    <>
      ...
      >
        <div className="flex items-center space-x-2 px-4 py-3">
          ...
          <span className="font-semibold hidden lg:inline">Chat with us</span>
        </div>
      ...
      {showBackToTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-6 left-6 z-40 bg-dark hover:bg-slate-800 text-white p-4 rounded-full shadow-2xl transition-all duration-300 hover:scale-110 animate-fade-in"
